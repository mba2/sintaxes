        ...
        <div class="col-xs-12 col-md-6">
          <form class="" id="" action="novo-usuario.php" method="post">
              <div class="form-group">
                <label id="" for="campo-nome-novo-usu" class="">nome de usuario</label>
              ...
              <div class="form-group">
                <label id="" for="campo-senha-novo-usu" class="">senha</label>
                <input type="password" id="campo-senha-novo-usu" required class="form-control" placeholder="Digite sua senha" name="senha-novo-usu">
              </div>

              <div class="form-group">
                <input type="submit" id="" class="btn btn-block btn-primary" name="submit" value="criar novo usuário">
              </div>
          </form>
        </div>
      </div>
